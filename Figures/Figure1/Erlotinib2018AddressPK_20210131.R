...
# Import
preclin.df = read.csv("../../ReferenceFiles/PreclinicalMetaAnalysis/PreclinicalErlotinib2018_20210212.csv",header=T)

# Tally
tally.df = as.data.frame(table(preclin.df$Paper.adresses.PK.))
...
# ggsave("ErlotinibPieChart.png",width=5.5,height=5.5)
