...
path = "../../../ReferenceFiles/EGFR_KIT/"

files = c("AlphaValues_EGFRCompiled_20211012.csv","AlphaValues_KITCompiled_20211012.csv")
...
for (i in 1:length(files)) {
  ...
  for (predictor in predictors) {
    ...
    g = ggplot(expnd.df,aes(x=drug,y=genotype,fill=correct.pred))+theme_minimal()+
